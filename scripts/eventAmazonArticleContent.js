...
// タイトル候補配列（メンタル・気分転換の文脈を少し入れつつ、12/1(月)までを明記）
export const eventAmazonArticleTitles = [
  '🎉 【12/1(月)まで】アマゾンブラックフライデーセール開催中！気分が上がるお得アイテムをチェック',
  '🛍️ 【12/1(月)まで】アマゾンブラックフライデーセール情報をお届けします（心がちょっとラクになる買い物編）',
  '💰 【12/1(月)まで】今だけの特別価格！「ちょっとした楽しみ」を迎えるブラックフライデーセール',
  '✨ 【12/1(月)まで】Amazonブラックフライデーセール情報まとめ（気分転換グッズ特集）',
  '🎁 【12/1(月)まで】Amazonブラックフライデーセールお得な情報をお届けします（ご褒美アイテム編）',
  '🔥 【12/1(月)まで】Amazonブラックフライデーセールでお買い物！心がふっと軽くなる選び方',
  '💸 【12/1(月)まで】Amazonブラックフライデーセールセール情報（無理のないご褒美消費）',
  '🎊 【12/1(月)まで】Amazonブラックフライデーセール開催！気持ちがラクになる要チェック商品まとめ',
];
...
export const eventAmazonArticleSections = [
  {
    title: '## 📅 2025年Amazonブラックフライデー：最高の「年越し準備」を始めるべき理由',
    text: `🎉 買うことは準備！お正月を気持ちよく迎えるための大作戦

今年も、Amazonの「ブラックフライデー」が開催されます！このセールは、ただのイベントではなく、来る年末年始を快適に、そしてお得に過ごすための「準備期間」だと捉えてみませんか？
...
生活費の「底値」を狙う 年末は何かと出費がかさみますが、ブラックフライデーで日常品や消耗品を一年で最も安い価格で手に入れれば、12月以降の出費をグッと抑えることができます。これは、家計をしっかり管理できているという安心感を生み出します。
...
全体としても、ブラックフライデーセールは12/1(月)までとなっています⏰
「今の自分を少しラクにしてくれる物」を迎えるきっかけとして、この期間を上手に使ってあげてください✨

あなたの生活と心を豊かにする買い物を、Amazonブラックフライデーでぜひお楽しみください。`,
  },
];
