...
// タイトル候補配列（メンタル・気分転換の文脈を少し入れつつ、12/8(月)までを明記）
export const eventAmazonArticleTitles = [
  '🎉 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール開催中！気分が上がるお得アイテムをチェック | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🛍️ 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール情報をお届けします（心がちょっとラクになる買い物編） | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '💰 【12/8(月)まで】今だけの特別価格！「ちょっとした楽しみ」を迎えるブラックフライデー（アフターセール）セール | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '✨ 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール情報まとめ（気分転換グッズ特集） | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🎁 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールお得な情報をお届けします（ご褒美アイテム編） | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🔥 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールでお買い物！心がふっと軽くなる選び方 | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '💸 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールセール情報（無理のないご褒美消費） | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🎊 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール開催！気持ちがラクになる要チェック商品まとめ | アマゾン | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
];

// 固定セクション（記事の先頭に必ず表示）
export const eventAmazonArticleHeaderSections = [
  {
    title: '## 🎉 アマゾンセール開催中！（心にもお財布にもやさしく）',
...
「これがあるとちょっと気分が上がる」そんな小さなご褒美アイテムを、この期間だけ少しだけゆるく探してみるのもおすすめです😊
...
export const eventAmazonArticleSections = [
  {
    title: '## 📅 2025年Amazonブラックフライデー（アフターセール）：最高の「年越し準備」を始めるべき理由',
    text: `🎉 買うことは準備！お正月を気持ちよく迎えるための大作戦

今年も、Amazonの「ブラックフライデー（アフターセール）」が開催されます！このセールは、ただのイベントではなく、来る年末年始を快適に、そしてお得に過ごすための「準備期間」だと捉えてみませんか？

なぜ、この時期の買い物があなたの年末を劇的に変えるのか、そのメリットを解説いたします。

1. 🎯 「計画買い」で家計の不安をスッキリ解消！

セールを利用して買い物することは、**「無駄遣いではなく、未来への賢い投資」**です。

生活費の「底値」を狙う 年末は何かと出費がかさみますが、ブラックフライデー（アフターセール）で日常品や消耗品を一年で最も安い価格で手に入れれば、12月以降の出費をグッと抑えることができます。これは、家計をしっかり管理できているという安心感を生み出します。

Amazonの注文履歴画面から今年買ったものの中でセールになっているものを買っておくと、お得にストックすることができて節約になります！🉐

「欲しいもの」をリストから削除！ 長い間「いつか買いたい」と思っていたものに、大幅な割引が適用されます。この機会に手に入れてしまえば、それ以上その商品を探す手間も、高値で買う心配もなくなります。気になっていたものをクリアにすることで、スッキリした気持ちで新年を迎えられます。

2. 💖 頑張った心と体に「ゆとり」をプレゼント

年末の買い物は、モノを買うこと以上に、「心のゆとり」を買う行為につながります。

ストレスを前もって避ける 年末は、大掃除や帰省の準備など、やるべきことが山積みです。今のうちに必要なアイテム（例えば、お正月用の食品や贈り物）を揃えておけば、12月の忙しさや焦りから解放されます。これは、自分自身に「ゆとりの時間」をプレゼントしていることになります。

小さな「喜び」を習慣にする セールで手に入れた新しいアイテムを見るたびに、「これはお得に手に入れたんだ！」という満足感が湧き上がります。この小さな喜びの積み重ねが、日々の生活の質を上げ、心が満たされた状態を保つのに役立ちます。

3. 🎁 年末年始の「特別なイベント」を輝かせる準備

これから始まるイベントシーズンに向けて、賢く準備を進めましょう。

プレゼント準備も完璧に クリスマスや年末年始の贈り物をこのセール期間中にまとめて選べば、予算内でより豪華なプレゼントを用意できます。早めに準備を終えることで、慌てずに相手のことを考えた贈り物を選ぶことができます。

お家時間を充実させる 新しいテレビで映画を見たり、高性能な調理家電で料理を楽しんだり。割引価格で手に入れたアイテムが、**家族や友人との「特別な時間」**をさらに豊かにしてくれます。

📅 お得な期間を最大限に活かしましょう！

最高の年末を迎えるためにも、このセール期間を逃さないようにご注意ください。
...
「今の自分を少しラクにしてくれる物」を迎えるきっかけとして、この期間を上手に使ってあげてください✨

あなたの生活と心を豊かにする買い物を、Amazonブラックフライデー（アフターセール）でぜひお楽しみください。`,
  },
];
