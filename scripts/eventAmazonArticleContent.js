...
export const eventAmazonArticleTitles = [
  '🎉 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール開催中！気分が上がるお得アイテムをチェック',
  '🛍️ 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール情報をお届けします（心がちょっとラクになる買い物編）',
  '💰 【12/8(月)まで】今だけの特別価格！「ちょっとした楽しみ」を迎えるブラックフライデー（アフターセール）セール',
  '✨ 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール情報まとめ（気分転換グッズ特集）',
  '🎁 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールお得な情報をお届けします（ご褒美アイテム編）',
  '🔥 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールでお買い物！心がふっと軽くなる選び方',
  '💸 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールセール情報（無理のないご褒美消費）',
  '🎊 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール開催！気持ちがラクになる要チェック商品まとめ',
];
