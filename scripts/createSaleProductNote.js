...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const titleCandidates = [
      '🉐 Amazonブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ別まとめ',
      '🎁 Amazonブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ毎にチェック',
      '📝 Amazonブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ別お得情報',
      '✨ Amazonブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ毎リンク集',
      '🛍️ Amazonブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ別セール情報',
      '💰 Amazonブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ毎お得商品',
    ];
    ...
    const closing = [
      ...
      '',
      '#Amazonブラックフライデー（アフターセール）セール #アマゾン #ブラックフライデー（アフターセール） #アマゾン #セール #お得 #買ってよかった #おすすめ #ショッピング #PR',
    ].join('\n');
