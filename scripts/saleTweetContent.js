...
export const saleTweetMessages = [
  ...
  '🎉 いよいよAmazonブラックフライデー。本番セール、いっしょに覗きませんか？🔥',
  ...
  '🤫 ブラックフライデーの日だけは、買い物ルールをゆるめてもいいかなって思ってます✨',
];

// 差分用の短い文章（一般的なセール案内用のひと言・ライトめのトーン）
// すべて「セールは12/1(月)まで〜」形式で、短くわかりやすい文にする
export const saleTweetPrefixVariations = [
  'セールは12/1(月)まで✨今がおトクなタイミング🎁',
  'セールは12/1(月)まで🔥今日は我慢解禁デー🎉',
  'セールは12/1(月)まで🎧気になってた物お試しチャンス✨',
  'セールは12/1(月)まで🛒「欲しかった物」だけチェック😊',
  'セールは12/1(月)まで🎀自分へのちょっとしたご褒美に🎁',
  'セールは12/1(月)まで🌙夜更かしショッピング解禁👀',
  'セールは12/1(月)まで📦「いつか買う」をそっと後押し💡',
  'セールは12/1(月)まで💖ちょっといい物を迎える日に✨',
  'セールは12/1(月)まで📦日用品の備蓄チャンス🧂',
  'セールは12/1(月)まで💰未来の私に優しい節約📉',
  'セールは12/1(月)まで📦ストック増やすなら今🧃',
  'セールは12/1(月)まで👀「欲しい物リスト」を見直す日📝',
  'セールは12/1(月)まで🔥買うならサクッと今⚡',
  'セールは12/1(月)まで✨先に仕込んで年末をラクに📦',
  'セールは12/1(月)まで📦一年分をゆるっとまとめ買い🗓️',
  'セールは12/1(月)まで👍リピ買い候補をチェック🛍️',
];
